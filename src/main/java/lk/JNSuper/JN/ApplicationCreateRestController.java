package lk.JNSuper.JN;


import lk.JNSuper.JN.asset.commonAsset.model.Enum.BloodGroup;
import lk.JNSuper.JN.asset.commonAsset.model.Enum.CivilStatus;
import lk.JNSuper.JN.asset.commonAsset.model.Enum.Gender;
import lk.JNSuper.JN.asset.commonAsset.model.Enum.Title;
import lk.JNSuper.JN.asset.employee.entity.Employee;
import lk.JNSuper.JN.asset.employee.entity.Enum.Designation;
import lk.JNSuper.JN.asset.employee.entity.Enum.EmployeeStatus;
import lk.JNSuper.JN.asset.employee.service.EmployeeService;
import lk.JNSuper.JN.asset.userManagement.entity.Role;
import lk.JNSuper.JN.asset.userManagement.entity.User;
import lk.JNSuper.JN.asset.userManagement.service.RoleService;
import lk.JNSuper.JN.asset.userManagement.service.UserService;
